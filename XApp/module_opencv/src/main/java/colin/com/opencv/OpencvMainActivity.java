 ...
 * @author yiche
 */
@Route(path = "/opencv/main")
public class OpencvMainActivity extends BaseActivity implements GLSurfaceView.Renderer{
    ...
    public int getLayout() {
        return R.layout.activity_opencv_main;
    }
